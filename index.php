...
<head>
    ...
    <script src="https://kit.fontawesome.com/8c297834dc.js" crossorigin="anonymous"></script>
    <!-- Google fonts-->
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="text-white-50">
                    Le jour de mes 20 ans j'ai eu un déclic, j'ai observé mon corps dans un miroir et je me suis senti
                    déçu.<br><br>
                    Je pesais 60kg pour 1m80, je manquais d'énergie et j'avais un mauvais cardio.<br>
                    C'est là que j'ai compris que j'avais un objectif à atteindre, que le corps dont je rêvais n'allait
                    pas tomber du ciel et qu'il fallait que je me donne les moyens de l'obtenir.<br>
                    Depuis ce jour est né une détermination sans faille pour construire et façonner mon corps. Et je
                    peux dire aujourd'hui que j'ai apprivoisé ce style de vie, car oui ... c'en est un !<br><br>
                    Bref, mon résultat actuel ?<br>
                    J'ai pris environ 15kg de muscles, j'ai gagné en énergie, en cardio et mon mental n'est clairement
                    plus le même !
                </p>
                <!--
                <p class="text-white-50">
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="featured-text text-center text-lg-left">
                    ...
                    <p class="text-black-50 mb-0">Les moyens que j'ai mis en oeuvre ?<br>Je te les partagerai volontier.
                        Ce sera un réel plaisir de t'aider à améliorer ta vie car oui, il ne s'agit pas ici que d'un
                        physique, c'est aussi ta confiance en toi, ton énergie, ton bien être !</p>
                </div>
            </div>
        </div>
        <!-- Project One Row-->
                ...
                <form class="form-group d-flex flex-column" action="src/send_email.php" method="post">
                    <div class="d-flex flex-rown">
                        <input class="form-control flex-fill mr-2 mb-3" name="contact_email" type="email"
                               placeholder="Email ..."
                               value="<?= isset($_SESSION['inputs']['contact_email']) ? $_SESSION['inputs']['contact_email'] : ''; ?>"/>
                    ...
                    <textarea class="form-control flex-fill mr-0 mr-sm-2 mb-3" name="contact_message" type="text"
                              placeholder="Message ..."><?= isset($_SESSION['inputs']['contact_message']) ? $_SESSION['inputs']['contact_message'] : ''; ?></textarea>
    ...
    <div class="container">
        ...
        <div class="bottom">
            <div class="d-flex justify-content-center"><a class="nav-link js-scroll-trigger btn btn-primary"
                                                          href="#home"><i class="fas fa-arrow-up"></i></a>
            </div>
            <!-- links-->
            <div class="social d-flex justify-content-center">
                <a class="mx-2" href="https://www.facebook.com/franckmalecki"><i class="fab fa-facebook-f"></i></a>
...
<footer class="footer bg-black small text-center text-white-50">
    <div class="container">Copyright © Jean-Baptiste Loup 2020</div>
</footer>
<!-- Bootstrap core JS-->
